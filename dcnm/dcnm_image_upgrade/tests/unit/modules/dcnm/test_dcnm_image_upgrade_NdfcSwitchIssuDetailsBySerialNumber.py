...
"""
ndfc_version: 12
description: Verify functionality of subclass NdfcSwitchIssuDetailsBySerialNumber
"""
...
def test_properties_are_set_to_expected_values(monkeypatch, module) -> None:
    """
    Properties are set based on serial_number setter value.
    endpoint: .../api/v1/imagemanagement/rest/packagemgnt/issu
    """
    ...
    module.serial_number = "FDO2112189M"
