...
nv_pairs_12_12e_keys = set(nv_pairs_12_12e.keys())
nv_pairs_12_13b_keys = set(nv_pairs_12_13b.keys())

# diff_12e_13b = nv_pairs_12_12e_keys.difference(nv_pairs_12_13b_keys)
# print(diff_12e_13b)
diff_13b_12e = nv_pairs_12_13b_keys.difference(nv_pairs_12_12e_keys)
# for key in sorted(diff_13b_12e):
#     print(f'{key}: "{nv_pairs_12_13b[key]}"')

for key in sorted(diff_13b_12e):
    print(f'        self._default_nv_pairs["{key}"] = "{nv_pairs_12_13b[key]}"')
